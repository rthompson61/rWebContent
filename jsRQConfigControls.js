...
function getExperienceLevels(bgRace){
	try{
		var exp = ["experienceLevel","updateSkills", "","Novice","Trained","Blooded","Experienced", "Veteran","Master","Exemplar"];
		var animals = ["Basilisk", "Bison", "Bolo Lizard", "Cliff Toad", "Cockatrice", "Demi-bird", "Dragonsnail", "Dream Dragon", "Ghoul", "Gorp", "High Llama", "Horse", "Horse, War", "Impala", "Jack O'Bear", "Rhino", "Rock Lizard", "Rubble Runner", "Sable", "Shadow Cat", "Skeleton", "Sky Bull", "Snake", "Tusker", "Unicorn", "Wyrm", "Wyvern", "Zombie" ];
		 if(bgRace == "Dragonewt"){
			 exp = ["experienceLevel","updateSkills", "","Crested","Beaked","Tailed Priest","Full Priest", "Inhuman King"];
		 }else{
